    ...
    <div class="w-full max-w-sm">
      ...
      <form class="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col gap-4" @submit.prevent="submit">
        ...
        <a
          ...
          class="flex items-center justify-center gap-2 w-full border border-gray-200 rounded-lg px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
        >
