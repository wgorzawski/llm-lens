...
<template>
  ...
  >
    <template v-if="name === 'logo'">
      <circle cx="11" cy="11" r="6.5" stroke-width="1.5" />
    ...
    <template v-else-if="name === 'list'">
      ...
      <line x1="3" y1="6" x2="3.01" y2="6" stroke-width="2.5" />
      <line x1="3" y1="12" x2="3.01" y2="12" stroke-width="2.5" />
      <line x1="3" y1="18" x2="3.01" y2="18" stroke-width="2.5" />
    </template>
    ...
    <template v-else-if="name === 'building'">
      ...
      <path d="M8 7h.01M12 7h.01M16 7h.01M8 11h.01M16 11h.01" stroke-width="2.5" stroke-linecap="round" />
    </template>
